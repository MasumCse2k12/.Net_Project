...
<head runat="server">
    <title>Delete User(Student)</title>
    ...
    <div>
      ...
      <div class="Registration_Form">
        <div class="Login_Info">
               <h1 style="text-align:center;color:red">Enter Id to Delete User</h1>
            <table style="padding-left:350px;">
                ...
                <tr>
                    <td></td>
                    <td><asp:Button ID="DelUser" Text="Delete User" runat="server" onClick="btnDelete_Click" Width="100px" Height="25px"/><br/>
                   </td>
